...
type Function func(args []interface{}, execCtx *ExecutionContext) (interface{}, error)
...
func (fr *FunctionRegistry) Call(name string, args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
...
func (fr *FunctionRegistry) registerStringFunctions() {
	...
	fr.functions["contains"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 2 {
	...
	fr.functions["startsWith"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 2 {
	...
	fr.functions["endsWith"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 2 {
	...
	fr.functions["format"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) == 0 {
	...
	fr.functions["join"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
	...
	fr.functions["toJSON"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {
	...
	fr.functions["fromJSON"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {
...
func (fr *FunctionRegistry) registerUtilityFunctions() {
	...
	fr.functions["success"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["always"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["cancelled"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["failure"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
...
func (fr *FunctionRegistry) registerContextFunctions() {
	...
	fr.functions["hashFiles"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) == 0 {
	...
	fr.functions["runner"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["job"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["needs"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
	...
	fr.functions["matrix"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 0 {
...
func (fr *FunctionRegistry) registerFileFunctions() {
	...
	fr.functions["glob"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {
...
func (fr *FunctionRegistry) registerObjectFunctions() {
	...
	fr.functions["keys"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {
	...
	fr.functions["values"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {
	...
	fr.functions["length"] = func(args []interface{}, execCtx *ExecutionContext) (interface{}, error) {
		if len(args) != 1 {

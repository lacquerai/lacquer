...
func (mc *ModelCache) GetModels(ctx context.Context, provider ModelProvider) ([]ModelInfo, error) {
	mc.mu.RLock()
...
func (mc *ModelCache) saveToCache(providerName string, models []ModelInfo) {
	cached := CachedModels{
		Models:    models,

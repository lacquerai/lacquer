...
func TestModelRegistry_RegisterProvider(t *testing.T) {
	...
	provider := NewMockModelProvider("test", []Info{
		{
			ID:       "model1",
			Name:     "model1",
			Provider: "test",
...
func TestModelRegistry_RegisterProvider_Duplicate(t *testing.T) {
	...
	provider1 := NewMockModelProvider("test", []Info{
		{
			ID:       "model1",
			Name:     "model1",
			Provider: "test",
	...
	provider2 := NewMockModelProvider("test", []Info{
		{
			ID:       "model2",
			Name:     "model2",
			Provider: "test",
...
func TestMockModelProvider_Generate(t *testing.T) {
	...
	request := &Request{
		Model:    "model1",
		Messages: []Message{{Role: "user", Content: []ContentBlockParamUnion{NewTextBlock("Hello, world!")}}},
	}
...
func TestModelRequest_Structure(t *testing.T) {
	request := &Request{
		Model:        "gpt-4",
		Messages:     []Message{{Role: "user", Content: []ContentBlockParamUnion{NewTextBlock("Hello")}}},
